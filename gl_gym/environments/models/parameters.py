...
def init_default_params(n_params):
    """
    Initializes a NumPy array of default physical, climate, greenhouse, crop,
                                                    and equipment parameters.

    Args:
        n_params (int): The number of parameters to initialize. 
            Must be at least 208 to accommodate all default parameters.

    Returns:
        params (np.ndarray): A NumPy array of shape (n_params,) containing 
            default values for a wide range of greenhouse simulation parameters.

    Notes:
        The parameter indices and their meanings are documented in the code comments.
        The function uses NumPy for array initialization and mathematical operations.
    """
    ...
    params[55] = 52.2           # aRoo           Roof area of the greenhouse [m2]
    ...
    params[64] = 2600.         # rhoR           Density of the roof [kg m-3]
    ...
    params[71] = 1.05          # lambdaR        Thermal conductivity of the roof [W m-1 K-1]
    params[72] = 840.          # cPR            Specific heat capacity of the roof [J kg-1 K-1]
    params[73] = 4e-3          # hR             Thickness of the roof [m]
    ...
    params[84] = 5e-4          # kThScr          Thermal screen flux coefficient
    ...
    params[102] = 1.73e6   # rhoCpSo         Volumetric heat capacity of the soil
    ...
    params[132] = 37_000        # eJ              Activation energy for Jpot calcualtion
    ...
    params[149] = 2.85e6       # cRgr            Regression coefficient in maintenance respiration function	    
    ...
    params[155] = 0.095        # rgLea          Growth respiration coefficient for leaf
    ...
    params[165] = 0.88            # epsGroPipe      FIR emission coefficient of the growth pipes
